...
<img src="https://latex.codecogs.com/svg.image?\\C=\sqrt{10^{2}&plus;15^{2}}=\sqrt{100&plus;225}=\sqrt{325}=18.03" title="\\C=\sqrt{10^{2}+15^{2}}=\sqrt{100+225}=\sqrt{325}=18.03" />
...
a) <img src="https://chart.apis.google.com/chart?cht=tx&chl=3.2%5Cangle%2011%20">
...
En los siguientes ejercicos se transformaran los siguientes numeros complejos a forma rectangular:
...
<img src="https://latex.codecogs.com/svg.image?\begin{aligned}&\frac{V_{B}-V_{A}}{680}&plus;\frac{V_{B}}{Z_{2}}&plus;\frac{V_{B}}{Z_{1}}=0&space;\\&\frac{V_{B}-V_{A}}{680}&plus;\frac{V_{B}}{(1.6&space;\mathrm{k}-j&space;0.419&space;\mathrm{k})}&plus;\frac{V_{B}}{(0.82&space;\mathrm{k}-j&space;2.89&space;\mathrm{k})}=0&space;\\&V_{B}(1.47&plus;0.59&plus;j&space;0.15&plus;0.09&plus;j&space;0.32)-1.47&space;V_{A}=0&space;\\&V_{B}(2.15&plus;j&space;0.47)-1.47&space;V_{A}=0&space;\ldots&space;\ldots&space;\text&space;{&space;(2)&space;}\end{aligned}" title="\begin{aligned}&\frac{V_{B}-V_{A}}{680}+\frac{V_{B}}{Z_{2}}+\frac{V_{B}}{Z_{1}}=0 \\&\frac{V_{B}-V_{A}}{680}+\frac{V_{B}}{(1.6 \mathrm{k}-j 0.419 \mathrm{k})}+\frac{V_{B}}{(0.82 \mathrm{k}-j 2.89 \mathrm{k})}=0 \\&V_{B}(1.47+0.59+j 0.15+0.09+j 0.32)-1.47 V_{A}=0 \\&V_{B}(2.15+j 0.47)-1.47 V_{A}=0 \ldots \ldots \text { (2) }\end{aligned}" />
...
<img src="https://latex.codecogs.com/svg.image?\begin{aligned}\mathrm{I}_{R&space;2}&space;&=\frac{V_{A}}{R_{2}}&space;\\&=\frac{0.44&space;\angle&space;71.51^{\circ}}{220}&space;\\\mathrm{I}_{R&space;2}&space;&=2&space;\angle&space;71.51^{\circ}&space;\mathrm{mA}\end{aligned}" title="\begin{aligned}\mathrm{I}_{R 2} &=\frac{V_{A}}{R_{2}} \\&=\frac{0.44 \angle 71.51^{\circ}}{220} \\\mathrm{I}_{R 2} &=2 \angle 71.51^{\circ} \mathrm{mA}\end{aligned}" />
...
<img src="https://latex.codecogs.com/svg.image?\\(b)\\[5pt]&space;P_{rA}=V_{s}I_{LA}sin(\theta&space;_{A})\\[5pt]&space;\theta&space;_{A}=cos^{-1}(0.85)=31.78^{\circ}&space;\\[5pt]&space;P_{rA}=240*4.8sin(31.78^{\circ})&space;=606&space;VAR\\[5pt]&space;P_{rB}=V_{s}I_{LB}sin(\theta&space;_{B})\\[5pt]&space;\theta&space;_{B}=cos^{-1}(0.95)=18.19^{\circ}&space;\\[5pt]&space;P_{rA}=240*3.33sin(18.19^{\circ})&space;=249.35&space;VAR\\[10pt]&space;&space;&space;" title="\\(b)\\[5pt] P_{rA}=V_{s}I_{LA}sin(\theta _{A})\\[5pt] \theta _{A}=cos^{-1}(0.85)=31.78^{\circ} \\[5pt] P_{rA}=240*4.8sin(31.78^{\circ}) =606 VAR\\[5pt] P_{rB}=V_{s}I_{LB}sin(\theta _{B})\\[5pt] \theta _{B}=cos^{-1}(0.95)=18.19^{\circ} \\[5pt] P_{rA}=240*3.33sin(18.19^{\circ}) =249.35 VAR\\[10pt] " />
...
**3. Exprese la impedancia total de cada circuito de la figura 16-54 tanto en forma polar como rectangula**
...
(a) 60 Hz (b) 200 Hz (c) 500 Hz (d) 1 kHz
 ...
 ![image](https://user-images.githubusercontent.com/93739242/155213769-e9408c59-d56f-4734-9b98-a94ea6509114.png)
...
<img src="https://latex.codecogs.com/svg.image?\\(d)\\[5pt]X_{L}=2\pi&space;fL&space;=2\pi&space;(1000Hz)(100mH)=628.3\Omega&space;\\[5pt]&space;Z=\sqrt{R^{2}&plus;X_{L}^{2}}\angle&space;tan^{-1}(\frac{X_{L}}{R})\\[5pt]&space;Z=\sqrt{150^{2}&plus;628.3^{2}}\angle&space;tan^{-1}(\frac{628.3\Omega&space;}{150\Omega&space;})=646\angle&space;76.6^{\circ}\Omega\\[5pt]&space;V_{R}=(\frac{R}{Z})V_{s}=(\frac{150\angle&space;0^{\circ}\Omega&space;}{646\angle&space;76.6^{\circ}\Omega&space;})(5\angle&space;0^{\circ}V)=1.16\angle&space;-76.6^{\circ}V\\[5pt]V_{L}=(\frac{X_{L}}{Z})V_{s}=(\frac{628.3\angle&space;90^{\circ}\Omega&space;}{646\angle&space;76.6^{\circ}\Omega&space;})(5\angle&space;0^{\circ}V)=4.86\angle&space;13.4^{\circ}V&space;\\[10pt]" title="\\(d)\\[5pt]X_{L}=2\pi fL =2\pi (1000Hz)(100mH)=628.3\Omega \\[5pt] Z=\sqrt{R^{2}+X_{L}^{2}}\angle tan^{-1}(\frac{X_{L}}{R})\\[5pt] Z=\sqrt{150^{2}+628.3^{2}}\angle tan^{-1}(\frac{628.3\Omega }{150\Omega })=646\angle 76.6^{\circ}\Omega\\[5pt] V_{R}=(\frac{R}{Z})V_{s}=(\frac{150\angle 0^{\circ}\Omega }{646\angle 76.6^{\circ}\Omega })(5\angle 0^{\circ}V)=1.16\angle -76.6^{\circ}V\\[5pt]V_{L}=(\frac{X_{L}}{Z})V_{s}=(\frac{628.3\angle 90^{\circ}\Omega }{646\angle 76.6^{\circ}\Omega })(5\angle 0^{\circ}V)=4.86\angle 13.4^{\circ}V \\[10pt]" />
...
[![04.png](https://i.postimg.cc/j5xXh9SK/04.png)](https://postimg.cc/064DkVSH)

7.75∠49.9°

**21. ¿A qué frecuencia XL es igual a R en la figura 16-63?**

 ![image](https://user-images.githubusercontent.com/93739242/155213850-badaa78e-341b-4a3a-970b-87283674ed77.png)


<img src="https://latex.codecogs.com/svg.image?\\&space;X_{L}=2\pi&space;fL\\[5pt]2\pi&space;fL=R\\[5pt]f=\frac{R}{2\pi&space;L}\to&space;\frac{12\Omega}{2\pi&space;(800\mu&space;H)}=2.39kHz&space;" title="\\ X_{L}=2\pi fL\\[5pt]2\pi fL=R\\[5pt]f=\frac{R}{2\pi L}\to \frac{12\Omega}{2\pi (800\mu H)}=2.39kHz " />

**23. Determine las siguientes cantidades en la figura 16-65: (a) Z (b) IR (c) IL (d) Itot (e) θ**
 
![image](https://user-images.githubusercontent.com/93739242/155213861-79ec41ba-f002-4b3a-939e-36c3bf96d85e.png)

<img src="https://latex.codecogs.com/svg.image?\\&space;(a)\\[5pt]X_{L}=2\pi&space;fL=2\pi&space;(2kHz)(25mH)=314\Omega\\[5pt]Z=(\frac{RX_{L}}{\sqrt{R^{2}&plus;X_{L}^{2}}})\angle&space;tan^{-1}(\frac{R}{X_{L}})\\[5pt]Z=\frac{(560\Omega&space;)(314\Omega&space;)}{\sqrt{(560\Omega&space;)^{2}&plus;(314\Omega&space;)^{2}}}\angle&space;tan^{-1}(\frac{560\Omega&space;}{314\Omega&space;})=274\angle&space;60.7^{\circ}\Omega&space;&space;" title="\\ (a)\\[5pt]X_{L}=2\pi fL=2\pi (2kHz)(25mH)=314\Omega\\[5pt]Z=(\frac{RX_{L}}{\sqrt{R^{2}+X_{L}^{2}}})\angle tan^{-1}(\frac{R}{X_{L}})\\[5pt]Z=\frac{(560\Omega )(314\Omega )}{\sqrt{(560\Omega )^{2}+(314\Omega )^{2}}}\angle tan^{-1}(\frac{560\Omega }{314\Omega })=274\angle 60.7^{\circ}\Omega " />

<img src="https://latex.codecogs.com/svg.image?\\&space;(b)\\[5pt]I_{R}=\frac{V_{s}}{R}=\frac{50\angle&space;0^{\circ}V}{560\angle&space;0^{\circ}\Omega&space;}=89.3\angle&space;0^{\circ}mA\\[15pt](c)\\[5pt]I_{L}=\frac{V_{s}}{X_{L}}=\frac{50\angle&space;0^{\circ}V}{314\angle&space;-90^{\circ}\Omega&space;}=159\angle&space;90^{\circ}mA\\[15pt](d)\\[5pt]I_{tot}=\frac{V_{s}}{Z}=\frac{50\angle&space;0^{\circ}V}{274\angle&space;60.7^{\circ}\Omega&space;}=182\angle&space;-60.7^{\circ}mA\\[15pt]&space;&space;" title="\\ (b)\\[5pt]I_{R}=\frac{V_{s}}{R}=\frac{50\angle 0^{\circ}V}{560\angle 0^{\circ}\Omega }=89.3\angle 0^{\circ}mA\\[15pt](c)\\[5pt]I_{L}=\frac{V_{s}}{X_{L}}=\frac{50\angle 0^{\circ}V}{314\angle -90^{\circ}\Omega }=159\angle 90^{\circ}mA\\[15pt](d)\\[5pt]I_{tot}=\frac{V_{s}}{Z}=\frac{50\angle 0^{\circ}V}{274\angle 60.7^{\circ}\Omega }=182\angle -60.7^{\circ}mA\\[15pt] " />

el ángulo es el ángulo en que la corriente total se retrasa con respecto al voltaje. Ya encontramos que esto es 60.7 


**25. Convierta el circuito mostrado en la figura 16-66 en uno equivalente en serie.**

[![05.png](https://i.postimg.cc/Xqhk4Yc7/05.png)](https://postimg.cc/5QBCm1RZ)

El resistor de 1.83 ohms en serie con la resistencia inductiva de 4.21 kohms
...
[![06.png](https://i.postimg.cc/8cqMxnN7/06.png)](https://postimg.cc/p5JmFC9v)
...
![image](https://user-images.githubusercontent.com/93739242/155213969-c72d511c-8ced-4d66-8c4e-8a6508596011.png)

 
<img src="https://latex.codecogs.com/svg.image?\\&space;L=\frac{L_{1}L_{2}}{L_{1}&plus;L_{2}}=\frac{(50mH)^{2}}{50mH&plus;50mH}=25mH&space;\\[5pt]X_{L}=2\pi&space;fL=2\pi&space;(400Hz)(25mH)=62.83\Omega&space;&space;&space;" title="\\ L=\frac{L_{1}L_{2}}{L_{1}+L_{2}}=\frac{(50mH)^{2}}{50mH+50mH}=25mH \\[5pt]X_{L}=2\pi fL=2\pi (400Hz)(25mH)=62.83\Omega " />

<img src="https://latex.codecogs.com/svg.image?\begin{aligned}&\mathbf{Z}_{\text&space;{A&space;}}=R_{3}&plus;j&space;X_{L}&space;\\&\mathbf{Z}_{\text&space;{A&space;}}=33&space;\Omega&plus;j&space;62.83&space;\Omega&space;\\&\mathbf{Z}_{\text&space;{A&space;}}=\sqrt{(33&space;\Omega)^{2}&plus;(62.83&space;\Omega)^{2}}&space;\angle&space;\tan&space;^{-1}\left(\frac{62.83&space;\Omega}{33&space;\Omega}\right)&space;\\&\mathbf{Z}_{\text&space;{A&space;}}=71.0&space;\angle&space;62.3^{\circ}&space;\Omega\end{aligned}&space;" title="\begin{aligned}&\mathbf{Z}_{\text {A }}=R_{3}+j X_{L} \\&\mathbf{Z}_{\text {A }}=33 \Omega+j 62.83 \Omega \\&\mathbf{Z}_{\text {A }}=\sqrt{(33 \Omega)^{2}+(62.83 \Omega)^{2}} \angle \tan ^{-1}\left(\frac{62.83 \Omega}{33 \Omega}\right) \\&\mathbf{Z}_{\text {A }}=71.0 \angle 62.3^{\circ} \Omega\end{aligned} " />

<img src="https://latex.codecogs.com/svg.image?\begin{aligned}\mathbf{Z}_{\mathrm{B}}&space;&=\frac{R_{2}&space;\mathbf{Z}_{\mathrm{A}}}{R_{2}&plus;\mathbf{Z}_{\mathrm{A}}}&space;\\&=\frac{(22&space;\Omega)(33&space;\Omega&plus;j&space;62.83&space;\Omega)}{22&space;\Omega&plus;33&space;\Omega&plus;j&space;62.83&space;\Omega}&space;\\\mathbf{Z}_{\mathrm{B}}&space;&=18.2&space;\Omega&plus;j&space;4.4&space;\Omega&space;\\\mathbf{Z}_{\mathrm{B}}&space;&=\sqrt{(18.2&space;\Omega)^{2}&plus;(4.4&space;\Omega)^{2}}&space;\angle&space;\tan&space;^{-1}\left(\frac{4.4&space;\Omega}{18.2&space;\Omega}\right)&space;\\\mathbf{Z}_{\mathrm{B}}&space;&=18.7&space;\angle&space;13.5^{\circ}&space;\Omega\end{aligned}&space;" title="\begin{aligned}\mathbf{Z}_{\mathrm{B}} &=\frac{R_{2} \mathbf{Z}_{\mathrm{A}}}{R_{2}+\mathbf{Z}_{\mathrm{A}}} \\&=\frac{(22 \Omega)(33 \Omega+j 62.83 \Omega)}{22 \Omega+33 \Omega+j 62.83 \Omega} \\\mathbf{Z}_{\mathrm{B}} &=18.2 \Omega+j 4.4 \Omega \\\mathbf{Z}_{\mathrm{B}} &=\sqrt{(18.2 \Omega)^{2}+(4.4 \Omega)^{2}} \angle \tan ^{-1}\left(\frac{4.4 \Omega}{18.2 \Omega}\right) \\\mathbf{Z}_{\mathrm{B}} &=18.7 \angle 13.5^{\circ} \Omega\end{aligned} " />

<img src="https://latex.codecogs.com/svg.image?\begin{aligned}\mathbf{Z}_{\mathrm{T}}&space;&=R_{1}&plus;\mathbf{Z}_{\mathrm{B}}&space;\\&=56&space;\Omega&plus;18.2&space;\Omega&plus;j&space;4.4&space;\Omega&space;\\\mathbf{Z}_{\mathrm{T}}&space;&=74.2&space;\Omega&plus;j&space;4.4&space;\Omega&space;\\\mathbf{Z}_{\mathrm{T}}&space;&=\sqrt{(74.2&space;\Omega)^{2}&plus;(4.4&space;\Omega)^{2}}&space;\angle&space;\tan&space;^{-1}\left(\frac{4.4&space;\Omega}{74.2&space;\Omega}\right)&space;\\\mathbf{Z}_{\mathrm{T}}&space;&=74.3&space;\angle&space;3.4^{\circ}&space;\Omega\end{aligned}" title="\begin{aligned}\mathbf{Z}_{\mathrm{T}} &=R_{1}+\mathbf{Z}_{\mathrm{B}} \\&=56 \Omega+18.2 \Omega+j 4.4 \Omega \\\mathbf{Z}_{\mathrm{T}} &=74.2 \Omega+j 4.4 \Omega \\\mathbf{Z}_{\mathrm{T}} &=\sqrt{(74.2 \Omega)^{2}+(4.4 \Omega)^{2}} \angle \tan ^{-1}\left(\frac{4.4 \Omega}{74.2 \Omega}\right) \\\mathbf{Z}_{\mathrm{T}} &=74.3 \angle 3.4^{\circ} \Omega\end{aligned}" />

<img src="https://latex.codecogs.com/svg.image?\begin{aligned}\mathbf{V}_{\mathrm{R}_{1}}&space;&=\left(\frac{\mathbf{R}_{1}}{\mathbf{Z}_{\mathrm{T}}}\right)&space;\mathbf{V}_{\mathrm{s}}&space;\\&=\left(\frac{56&space;\angle&space;0^{\circ}&space;\Omega}{74.3&space;\angle&space;3.4^{\circ}&space;\Omega}\right)\left(25&space;\angle&space;0^{\circ}&space;\mathrm{V}\right)&space;\\\mathbf{V}_{\mathrm{R}_{1}}&space;&=18.8&space;\angle-3.4^{\circ}&space;\mathrm{V}\end{aligned}" title="\begin{aligned}\mathbf{V}_{\mathrm{R}_{1}} &=\left(\frac{\mathbf{R}_{1}}{\mathbf{Z}_{\mathrm{T}}}\right) \mathbf{V}_{\mathrm{s}} \\&=\left(\frac{56 \angle 0^{\circ} \Omega}{74.3 \angle 3.4^{\circ} \Omega}\right)\left(25 \angle 0^{\circ} \mathrm{V}\right) \\\mathbf{V}_{\mathrm{R}_{1}} &=18.8 \angle-3.4^{\circ} \mathrm{V}\end{aligned}" />
<img src="https://latex.codecogs.com/svg.image?\begin{aligned}\mathbf{V}_{\mathrm{R}_{2}}&space;&=\left(\frac{\mathbf{Z}_{B}}{\mathbf{Z}_{\mathrm{T}}}\right)&space;\mathbf{V}_{\mathrm{s}}&space;\\&=\left(\frac{18.7&space;\angle&space;13.6^{\circ}&space;\Omega}{74.3&space;\angle&space;3.4^{\circ}&space;\Omega}\right)\left(25&space;\angle&space;0^{\circ}&space;\mathrm{V}\right)&space;\\\mathbf{V}_{\mathrm{R}_{1}}&space;&=6.3&space;\angle10.2^{\circ}&space;\mathrm{V}\end{aligned}" title="\begin{aligned}\mathbf{V}_{\mathrm{R}_{2}} &=\left(\frac{\mathbf{Z}_{B}}{\mathbf{Z}_{\mathrm{T}}}\right) \mathbf{V}_{\mathrm{s}} \\&=\left(\frac{18.7 \angle 13.6^{\circ} \Omega}{74.3 \angle 3.4^{\circ} \Omega}\right)\left(25 \angle 0^{\circ} \mathrm{V}\right) \\\mathbf{V}_{\mathrm{R}_{1}} &=6.3 \angle10.2^{\circ} \mathrm{V}\end{aligned}" />

<img src="https://latex.codecogs.com/svg.image?\begin{aligned}\mathbf{V}_{\mathrm{R}_{3}}&space;&=\left(\frac{\mathbf{R}_{3}}{\mathbf{Z}_{\mathrm{A}}}\right)&space;\mathbf{V}_{\mathrm{R3}}&space;\\&=\left(\frac{33&space;\angle&space;0^{\circ}&space;\Omega}{71.1&space;\angle&space;62.4^{\circ}&space;\Omega}\right)\left(6.3&space;\angle&space;10.2^{\circ}&space;\mathrm{V}\right)&space;\\\mathbf{V}_{\mathrm{R}_{1}}&space;&=2.9&space;\angle-52.2^{\circ}&space;\mathrm{V}\end{aligned}" title="\begin{aligned}\mathbf{V}_{\mathrm{R}_{3}} &=\left(\frac{\mathbf{R}_{3}}{\mathbf{Z}_{\mathrm{A}}}\right) \mathbf{V}_{\mathrm{R3}} \\&=\left(\frac{33 \angle 0^{\circ} \Omega}{71.1 \angle 62.4^{\circ} \Omega}\right)\left(6.3 \angle 10.2^{\circ} \mathrm{V}\right) \\\mathbf{V}_{\mathrm{R}_{1}} &=2.9 \angle-52.2^{\circ} \mathrm{V}\end{aligned}" />

<img src="https://latex.codecogs.com/svg.image?\begin{aligned}&V_{L1}=V_{L2}=V_{L}\\\mathbf{V}_{\mathrm{L}}&space;&=\left(\frac{\mathbf{X}_{L}}{\mathbf{Z}_{\mathrm{A}}}\right)&space;\mathbf{V}_{\mathrm{R2}}&space;\\&=\left(\frac{63&space;\angle&space;90^{\circ}&space;\Omega}{71.1&space;\angle&space;62.4^{\circ}&space;\Omega}\right)\left(6.3&space;\angle&space;10.2^{\circ}&space;\mathrm{V}\right)&space;\\\mathbf{V}_{\mathrm{R}_{1}}&space;&=5.6&space;\angle37.8^{\circ}&space;\mathrm{V}\end{aligned}" title="\begin{aligned}&V_{L1}=V_{L2}=V_{L}\\\mathbf{V}_{\mathrm{L}} &=\left(\frac{\mathbf{X}_{L}}{\mathbf{Z}_{\mathrm{A}}}\right) \mathbf{V}_{\mathrm{R2}} \\&=\left(\frac{63 \angle 90^{\circ} \Omega}{71.1 \angle 62.4^{\circ} \Omega}\right)\left(6.3 \angle 10.2^{\circ} \mathrm{V}\right) \\\mathbf{V}_{\mathrm{R}_{1}} &=5.6 \angle37.8^{\circ} \mathrm{V}\end{aligned}" />

<img src="https://latex.codecogs.com/svg.image?\begin{aligned}\mathbf{I}_{\mathrm{R}_{1}}=&\frac{\mathbf{V}_{\mathrm{R}_{1}}}{\mathbf{R}_{1}}&space;\\=&&space;\frac{18.8&space;\angle-3.4^{\circ}&space;\mathrm{V}}{56&space;\angle&space;0^{\circ}&space;\Omega}&space;\\\mathbf{I}_{\mathrm{R}_{1}}=&336&space;\angle-3.4^{\circ}&space;\mathrm{mA}&space;\\\mathbf{I}_{\mathrm{R}_{2}}=&&space;\frac{\mathbf{V}_{\mathrm{R}_{2}}}{\mathbf{R}_{2}}&space;\\=&&space;\frac{6.3&space;\angle&space;10.2^{\circ}&space;\mathrm{V}}{22&space;\angle&space;0^{\circ}&space;\Omega}&space;\\\mathbf{I}_{\mathrm{R}_{2}}=&286&space;\angle&space;10.2^{\circ}&space;\mathrm{mA}&space;\\\mathbf{I}_{\mathrm{R}_{3}}=&\frac{\mathbf{V}_{\mathrm{R}_{3}}}{\mathbf{R}_{3}}&space;\\=&\frac{2.9&space;\angle-52.2^{\circ}&space;\mathrm{V}}{33&space;\angle&space;0^{\circ}&space;\Omega}\\\mathbf{I}_{\mathrm{R}_{3}}=&88&space;\angle&space;-52.2^{\circ}&space;\mathrm{mA}&space;\\\end{aligned}" title="\begin{aligned}\mathbf{I}_{\mathrm{R}_{1}}=&\frac{\mathbf{V}_{\mathrm{R}_{1}}}{\mathbf{R}_{1}} \\=& \frac{18.8 \angle-3.4^{\circ} \mathrm{V}}{56 \angle 0^{\circ} \Omega} \\\mathbf{I}_{\mathrm{R}_{1}}=&336 \angle-3.4^{\circ} \mathrm{mA} \\\mathbf{I}_{\mathrm{R}_{2}}=& \frac{\mathbf{V}_{\mathrm{R}_{2}}}{\mathbf{R}_{2}} \\=& \frac{6.3 \angle 10.2^{\circ} \mathrm{V}}{22 \angle 0^{\circ} \Omega} \\\mathbf{I}_{\mathrm{R}_{2}}=&286 \angle 10.2^{\circ} \mathrm{mA} \\\mathbf{I}_{\mathrm{R}_{3}}=&\frac{\mathbf{V}_{\mathrm{R}_{3}}}{\mathbf{R}_{3}} \\=&\frac{2.9 \angle-52.2^{\circ} \mathrm{V}}{33 \angle 0^{\circ} \Omega}\\\mathbf{I}_{\mathrm{R}_{3}}=&88 \angle -52.2^{\circ} \mathrm{mA} \\\end{aligned}" />

<img src="https://latex.codecogs.com/svg.image?\\I_{L1}=I_{L2}=\frac{I_{R3}}{2}=\frac{88\angle&space;-52.2^{\circ}mA}{2}=44\angle&space;-52.2^{\circ}mA" title="\\I_{L1}=I_{L2}=\frac{I_{R3}}{2}=\frac{88\angle -52.2^{\circ}mA}{2}=44\angle -52.2^{\circ}mA" />

**31. Para el circuito de la figura 16-70, determine lo siguiente:**

![image](https://user-images.githubusercontent.com/93739242/155214114-ecd16b73-8688-4818-9f13-b660875240cf.png)


<img src="https://latex.codecogs.com/svg.image?\begin{aligned}\mathbf{Z}_{\mathrm{A}}&space;&=\frac{R_{2}\left(j&space;X_{L_{1}}\right)}{R_{2}&plus;j&space;X_{L_{4}}}&space;\\&=\frac{(68&space;\Omega)(j&space;100&space;\Omega)}{68&space;\Omega&plus;j&space;100&space;\Omega}&space;\\\mathbf{Z}_{\mathrm{A}}&space;&=46.5&space;\Omega&plus;j&space;31.6&space;\Omega&space;\\\mathbf{Z}_{\mathrm{A}}&space;&=\sqrt{(46.5&space;\Omega)^{2}&plus;(31.6&space;\Omega)^{2}}&space;\angle&space;\tan&space;^{-1}\left(\frac{31.6&space;\Omega}{46.5&space;\Omega}\right)&space;\\\mathbf{Z}_{\mathrm{A}}&space;&=56&space;\angle&space;34.2^{\circ}&space;\Omega\end{aligned}" title="\begin{aligned}\mathbf{Z}_{\mathrm{A}} &=\frac{R_{2}\left(j X_{L_{1}}\right)}{R_{2}+j X_{L_{4}}} \\&=\frac{(68 \Omega)(j 100 \Omega)}{68 \Omega+j 100 \Omega} \\\mathbf{Z}_{\mathrm{A}} &=46.5 \Omega+j 31.6 \Omega \\\mathbf{Z}_{\mathrm{A}} &=\sqrt{(46.5 \Omega)^{2}+(31.6 \Omega)^{2}} \angle \tan ^{-1}\left(\frac{31.6 \Omega}{46.5 \Omega}\right) \\\mathbf{Z}_{\mathrm{A}} &=56 \angle 34.2^{\circ} \Omega\end{aligned}" />

<img src="https://latex.codecogs.com/svg.image?\begin{aligned}\mathbf{Z}_{\mathrm{B}}&space;&=R_{1}&plus;\mathbf{Z}_{\mathrm{A}}&space;\\&=50&space;\Omega&plus;46.5&space;\Omega&plus;j&space;31.6&space;\Omega&space;\\\mathbf{Z}_{\mathrm{B}}&space;&=96.5&space;\Omega&plus;j&space;31.6&space;\Omega&space;\\\mathbf{Z}_{\mathrm{B}}&space;&=\sqrt{(96.5&space;\Omega)^{2}&plus;(31.6&space;\Omega)^{2}}&space;\angle&space;\tan&space;^{-1}\left(\frac{31.6&space;\Omega}{96.5&space;\Omega}\right)&space;\\\mathbf{Z}_{\mathrm{B}}&space;&=102&space;\angle&space;18.1^{\circ}&space;\Omega\end{aligned}" title="\begin{aligned}\mathbf{Z}_{\mathrm{B}} &=R_{1}+\mathbf{Z}_{\mathrm{A}} \\&=50 \Omega+46.5 \Omega+j 31.6 \Omega \\\mathbf{Z}_{\mathrm{B}} &=96.5 \Omega+j 31.6 \Omega \\\mathbf{Z}_{\mathrm{B}} &=\sqrt{(96.5 \Omega)^{2}+(31.6 \Omega)^{2}} \angle \tan ^{-1}\left(\frac{31.6 \Omega}{96.5 \Omega}\right) \\\mathbf{Z}_{\mathrm{B}} &=102 \angle 18.1^{\circ} \Omega\end{aligned}" />

<img src="https://latex.codecogs.com/svg.image?\begin{aligned}X_{L_{23}}&space;&=X_{L_{2}}&plus;X_{L_{3}}&space;\\&=75&space;\Omega&plus;45&space;\Omega&space;\\X_{L_{23}}&space;&=120&space;\Omega&space;\\\mathbf{Z}_{\mathrm{T}}&space;&=\frac{\mathbf{Z}_{\mathrm{B}}\left(j&space;X_{L_{23}}\right)}{\mathbf{Z}_{\mathrm{B}}&plus;j&space;X_{L_{23}}}&space;\\&=\frac{(96.5&space;\Omega&plus;j&space;31.6&space;\Omega)(j&space;120&space;\Omega)}{96.5&space;\Omega&plus;j&space;31.6&space;\Omega&plus;j&space;120&space;\Omega}&space;\\\mathbf{Z}_{\mathrm{T}}&space;&=43&space;\Omega&plus;j&space;32&space;\Omega&space;\\\mathbf{Z}_{\mathrm{T}}&space;&=\sqrt{(43&space;\Omega)^{2}&plus;(52&space;\Omega)^{2}}&space;\angle&space;\tan&space;^{-1}\left(\frac{52&space;\Omega}{43&space;\Omega}\right)&space;\\\mathbf{Z}_{\mathrm{T}}&space;&=67.8&space;\angle&space;50.6^{\circ}&space;\Omega\end{aligned}" title="\begin{aligned}X_{L_{23}} &=X_{L_{2}}+X_{L_{3}} \\&=75 \Omega+45 \Omega \\X_{L_{23}} &=120 \Omega \\\mathbf{Z}_{\mathrm{T}} &=\frac{\mathbf{Z}_{\mathrm{B}}\left(j X_{L_{23}}\right)}{\mathbf{Z}_{\mathrm{B}}+j X_{L_{23}}} \\&=\frac{(96.5 \Omega+j 31.6 \Omega)(j 120 \Omega)}{96.5 \Omega+j 31.6 \Omega+j 120 \Omega} \\\mathbf{Z}_{\mathrm{T}} &=43 \Omega+j 32 \Omega \\\mathbf{Z}_{\mathrm{T}} &=\sqrt{(43 \Omega)^{2}+(52 \Omega)^{2}} \angle \tan ^{-1}\left(\frac{52 \Omega}{43 \Omega}\right) \\\mathbf{Z}_{\mathrm{T}} &=67.8 \angle 50.6^{\circ} \Omega\end{aligned}" />

<img src="https://latex.codecogs.com/svg.image?\\I_{T}=\frac{V_{s}}{Z_{T}}=\frac{40\angle&space;0^{\circ}V}{67.8\angle&space;50.6^{\circ}\Omega&space;}=589\angle&space;-50.6^{\circ}mA" title="\\I_{T}=\frac{V_{s}}{Z_{T}}=\frac{40\angle 0^{\circ}V}{67.8\angle 50.6^{\circ}\Omega }=589\angle -50.6^{\circ}mA" />

<img src="https://latex.codecogs.com/svg.image?\\V_{L1}=V_{ZA}=(\frac{Z_{A}}{Z_{B}})V_{s}=(\frac{56\angle&space;34.2^{\circ}\Omega&space;}{102\angle&space;18.1\Omega&space;})(40\angle&space;0^{\circ}V)=22\angle&space;16.1^{\circ}&space;V&space;" title="\\V_{L1}=V_{ZA}=(\frac{Z_{A}}{Z_{B}})V_{s}=(\frac{56\angle 34.2^{\circ}\Omega }{102\angle 18.1\Omega })(40\angle 0^{\circ}V)=22\angle 16.1^{\circ} V " />

<img src="https://latex.codecogs.com/svg.image?\begin{aligned}\mathbf{V}_{\mathrm{A}}&space;&=\left(\frac{X_{L&space;3}}{X_{L&space;2}&plus;X_{L&space;3}}\right)&space;\mathbf{V}_{\mathrm{s}}&space;\\&=\left(\frac{45&space;\Omega}{75&space;\Omega&plus;45&space;\Omega}\right)\left(40&space;\angle&space;0^{\circ}\right)&space;\\\mathbf{V}_{\mathrm{A}}&space;&=15&space;\mathrm{~V}&plus;j&space;0&space;\mathrm{~V}\end{aligned}" title="\begin{aligned}\mathbf{V}_{\mathrm{A}} &=\left(\frac{X_{L 3}}{X_{L 2}+X_{L 3}}\right) \mathbf{V}_{\mathrm{s}} \\&=\left(\frac{45 \Omega}{75 \Omega+45 \Omega}\right)\left(40 \angle 0^{\circ}\right) \\\mathbf{V}_{\mathrm{A}} &=15 \mathrm{~V}+j 0 \mathrm{~V}\end{aligned}" />

<img src="https://latex.codecogs.com/svg.image?V_{AB}=V_{A}-V_{B}=15V-(21V&plus;j6.1V)=-6V-j6.1V" title="V_{AB}=V_{A}-V_{B}=15V-(21V+j6.1V)=-6V-j6.1V" />

<img src="https://latex.codecogs.com/svg.image?V_{AB}=\sqrt{(-6)^{2}&plus;(-6.1)^{2}}\angle&space;(tan^{-1}(\frac{-6.1V}{-6V})&plus;180^{\circ})=8.56\angle&space;-135^{\circ}V" title="V_{AB}=\sqrt{(-6)^{2}+(-6.1)^{2}}\angle (tan^{-1}(\frac{-6.1V}{-6V})+180^{\circ})=8.56\angle -135^{\circ}V" />
...
[![07.png](https://i.postimg.cc/gcwMtCKk/07.png)](https://postimg.cc/t7jtYmfL)

Theta = 52.5°(el voltaje de salida esta retrasado conrespecto a el voltaje de entrada)
...
[![04.png](https://i.postimg.cc/rwTGK2Lg/04.png)](https://postimg.cc/mtd15qkF)

**37. Determine la potencia verdadera y la potencia reactiva en la figura 16-58**
 
 ![image](https://user-images.githubusercontent.com/93739242/155214295-ff930e39-b966-4cbe-be8f-7aa00c83eb79.png)


<img src="https://latex.codecogs.com/svg.image?\\\textit{Encontramos&space;la&space;reactancia&space;del&space;inductor}\\[5pt]X_{L}=2\pi&space;fL=2\pi&space;(60Hz)(0.1H)=37.7\Omega&space;\\[5pt]\textit{La&space;impedancia&space;es:}\\[5pt]Z=R&plus;jX_{L}=\sqrt{R^{2}&plus;X_{L}^{2}}\angle&space;tan^{-1}(\frac{X_{L}}{R})\\[5pt]Z=\sqrt{(47)^{2}&plus;(37.7)^{2}}\angle&space;tan^{-1}(\frac{37.7}{47})=60.3\angle&space;38.7^{\circ}&space;\Omega\\[5pt]I=\frac{V}{Z}=\frac{10}{60.3}=166mA&space;\\[5pt]\textit{Encontramos&space;la&space;potencia&space;verdadera&space;y&space;la&space;potencia&space;reactiva&space;}&space;\\[5pt]P_{true}=V_{s}Icos\theta&space;=(10V)(166mAcos(38.7^{\circ}))=1.29W\\[5pt]&space;P_{r}=V_{s}Isin\theta&space;=(10V)(166mA)sin(38.7^{\circ})=1.04VAR&space;" title="\\\textit{Encontramos la reactancia del inductor}\\[5pt]X_{L}=2\pi fL=2\pi (60Hz)(0.1H)=37.7\Omega \\[5pt]\textit{La impedancia es:}\\[5pt]Z=R+jX_{L}=\sqrt{R^{2}+X_{L}^{2}}\angle tan^{-1}(\frac{X_{L}}{R})\\[5pt]Z=\sqrt{(47)^{2}+(37.7)^{2}}\angle tan^{-1}(\frac{37.7}{47})=60.3\angle 38.7^{\circ} \Omega\\[5pt]I=\frac{V}{Z}=\frac{10}{60.3}=166mA \\[5pt]\textit{Encontramos la potencia verdadera y la potencia reactiva } \\[5pt]P_{true}=V_{s}Icos\theta =(10V)(166mAcos(38.7^{\circ}))=1.29W\\[5pt] P_{r}=V_{s}Isin\theta =(10V)(166mA)sin(38.7^{\circ})=1.04VAR " />


**39. Determine P, Q, S y FP para el circuito de la figura 16-69. Trace el triángulo de potencia.**

 ![image](https://user-images.githubusercontent.com/93739242/155214276-159fe613-53ef-484b-a9ab-fb1c39763271.png)

 
<img src="https://latex.codecogs.com/svg.image?\\\textit{Encontramos&space;las&space;reactancias&space;de&space;los&space;inductores}\\[5pt]X_{L}=2\pi&space;fL=2\pi&space;(80Hz)(10mH)=5k\Omega&space;\\[5pt]X_{L}=2\pi&space;fL=2\pi&space;(80Hz)(8mH)=4k\Omega&space;\\[5pt]\textit{La&space;impedancia&space;A&space;R3&space;en&space;serie&space;con&space;L2&space;y&space;paralelo&space;con&space;R2}\\[5pt]Z_{A}=\frac{R_{2}(R_{3}&plus;jX_{L2})}{R_{2}&plus;(R_{3}&plus;jX_{L2})}=\frac{(3.3k\Omega&space;)(5.6k\Omega&space;&plus;j4k\Omega&space;)}{3.3k\Omega&plus;5.6k\Omega&space;&plus;j4k\Omega}\\[5pt]\textit{Forma&space;Polar}\\[5pt]Z_{A}=\sqrt{(2.3k\Omega&space;)^{2}&plus;(0.46k\Omega&space;)^{2}}\angle&space;tan^{-1}(\frac{0.46}{2.3})=2.34\angle&space;11.3^{\circ}&space;\Omega\\[5pt]\textit{La&space;impedancia&space;Za&space;esta&space;en&space;serie&space;con&space;L1}\\[5pt]Z_{B}=Z_{A}&plus;jX_{L1}=2.3k\Omega&space;&plus;j0.46k\Omega&space;&plus;j5k\Omega&space;=2.3k\Omega&space;&plus;j5.46k\Omega\\[5pt]\textit{Forma&space;Polar}\\[5pt]Z_{B}=\sqrt{(2.3k\Omega&space;)^{2}&plus;(5.46k\Omega&space;)^{2}}\angle&space;tan^{-1}(\frac{5.46}{2.3})=5.92\angle&space;67.16^{\circ}&space;\Omega\\[5pt]" title="\\\textit{Encontramos las reactancias de los inductores}\\[5pt]X_{L}=2\pi fL=2\pi (80Hz)(10mH)=5k\Omega \\[5pt]X_{L}=2\pi fL=2\pi (80Hz)(8mH)=4k\Omega \\[5pt]\textit{La impedancia A R3 en serie con L2 y paralelo con R2}\\[5pt]Z_{A}=\frac{R_{2}(R_{3}+jX_{L2})}{R_{2}+(R_{3}+jX_{L2})}=\frac{(3.3k\Omega )(5.6k\Omega +j4k\Omega )}{3.3k\Omega+5.6k\Omega +j4k\Omega}\\[5pt]\textit{Forma Polar}\\[5pt]Z_{A}=\sqrt{(2.3k\Omega )^{2}+(0.46k\Omega )^{2}}\angle tan^{-1}(\frac{0.46}{2.3})=2.34\angle 11.3^{\circ} \Omega\\[5pt]\textit{La impedancia Za esta en serie con L1}\\[5pt]Z_{B}=Z_{A}+jX_{L1}=2.3k\Omega +j0.46k\Omega +j5k\Omega =2.3k\Omega +j5.46k\Omega\\[5pt]\textit{Forma Polar}\\[5pt]Z_{B}=\sqrt{(2.3k\Omega )^{2}+(5.46k\Omega )^{2}}\angle tan^{-1}(\frac{5.46}{2.3})=5.92\angle 67.16^{\circ} \Omega\\[5pt]" />

<img src="https://latex.codecogs.com/svg.image?\\\textit{La&space;impedancia&space;Zb&space;esta&space;en&space;paralelo&space;con&space;R1}\\[5pt]&space;R_{T}=\frac{R_{1}Z_{B}}{R_{1}&plus;Z_{B}}=\frac{(1.2k\Omega&space;)(2.3k\Omega&space;&plus;j5.46k\Omega)}{1.2k\Omega&space;&plus;2.3k\Omega&space;&plus;j5.46k\Omega}=1.08k\Omega&space;&plus;j0.187k\Omega&space;\\[5pt]&space;\textit{Forma&space;Polar}\\[5pt]&space;Z_{T}=\sqrt{(1.08k\Omega&space;)^{2}&plus;(0.187k\Omega&space;)^{2}}\angle&space;tan^{-1}(\frac{0.187}{21.08})=1.1\angle&space;9.8^{\circ}&space;k\Omega\\[5pt]\textit{La&space;corriente&space;Total}\\[5pt]I_{T}=\frac{V_{s}}{Z_{T}}=\frac{18\angle&space;0^{\circ&space;V}}{1.1\angle&space;9.8^{\circ}&space;k\Omega}=16.4\angle&space;-9.8^{\circ}mA\\[5pt]\textit{Encontramos&space;la&space;potencia&space;P&space;y&space;Q}\\[5pt]P=V_{s}I_{T}cos\theta&space;=(18V)(16.4mA)cos(9.8^{\circ})=290mW\\[5pt]Q=V_{s}I_{T}sin\theta&space;=(18V)(16.4mA)sin(9.8^{\circ})=50.25mVAR\\[5pt]\textit{Asi&space;la&space;magnitud&space;de&space;la&space;potencia&space;aparente&space;compleja}\\[5pt]S=\sqrt{P^{2}&plus;Q^{2}}=\sqrt{(290mW)^{2}&plus;(50.25mVAR)^{2}}=294mVA\\[5pt]\textit{El&space;factor&space;de&space;potencia&space;es&space;el&space;coseno&space;del&space;angulo}&space;\\[5pt]PF=cos\theta&space;=cos(9.8^{\circ})=0.985&space;" title="\\\textit{La impedancia Zb esta en paralelo con R1}\\[5pt] R_{T}=\frac{R_{1}Z_{B}}{R_{1}+Z_{B}}=\frac{(1.2k\Omega )(2.3k\Omega +j5.46k\Omega)}{1.2k\Omega +2.3k\Omega +j5.46k\Omega}=1.08k\Omega +j0.187k\Omega \\[5pt] \textit{Forma Polar}\\[5pt] Z_{T}=\sqrt{(1.08k\Omega )^{2}+(0.187k\Omega )^{2}}\angle tan^{-1}(\frac{0.187}{21.08})=1.1\angle 9.8^{\circ} k\Omega\\[5pt]\textit{La corriente Total}\\[5pt]I_{T}=\frac{V_{s}}{Z_{T}}=\frac{18\angle 0^{\circ V}}{1.1\angle 9.8^{\circ} k\Omega}=16.4\angle -9.8^{\circ}mA\\[5pt]\textit{Encontramos la potencia P y Q}\\[5pt]P=V_{s}I_{T}cos\theta =(18V)(16.4mA)cos(9.8^{\circ})=290mW\\[5pt]Q=V_{s}I_{T}sin\theta =(18V)(16.4mA)sin(9.8^{\circ})=50.25mVAR\\[5pt]\textit{Asi la magnitud de la potencia aparente compleja}\\[5pt]S=\sqrt{P^{2}+Q^{2}}=\sqrt{(290mW)^{2}+(50.25mVAR)^{2}}=294mVA\\[5pt]\textit{El factor de potencia es el coseno del angulo} \\[5pt]PF=cos\theta =cos(9.8^{\circ})=0.985 " />

 
![image](https://user-images.githubusercontent.com/93739242/155214253-e181f20d-18be-40a9-9293-a496daea769c.png)
...
[![08.png](https://i.postimg.cc/cCqfbbsr/08.png)](https://postimg.cc/S2rXXVYh)


Utilisando la fórmula del voltaje de salida 

[![05.png](https://i.postimg.cc/D0mjpkz1/05.png)](https://postimg.cc/ctyB6zwJ)

**43. Trace el diagrama fasorial de voltaje para cada circuito de las figuras 16-61 y 16-62 a una frecuencia de 8 kHz.**

[![03.png](https://i.postimg.cc/Y04GybBv/03.png)](https://postimg.cc/n9JhXKzx)

**45. Determine el voltaje de salida en la figura 16-73 para cada uno de los siguientes modos de falla:**
 
 ![image](https://user-images.githubusercontent.com/93739242/155214365-818e21b7-1d22-415a-bbca-56fb8ec94abe.png)


<img src="https://latex.codecogs.com/svg.image?\\\textit{Primero&space;encontramos&space;las&space;reactancias&space;de&space;los&space;inductores}\\[5pt]X_{L1}=2\pi&space;fL_{1}=2\pi&space;(1MHz)(8\mu&space;H)=50.3\Omega&space;\\[5pt]X_{L2}=&space;2\pi&space;fL_{1}=2\pi&space;(1MHz)(4\mu&space;H)=25.1\Omega&space;\\[5pt]&space;" title="\\\textit{Primero encontramos las reactancias de los inductores}\\[5pt]X_{L1}=2\pi fL_{1}=2\pi (1MHz)(8\mu H)=50.3\Omega \\[5pt]X_{L2}= 2\pi fL_{1}=2\pi (1MHz)(4\mu H)=25.1\Omega \\[5pt] " />

(a) L1 abierto

Si L1 se abre, entonces ya no hay un circuito cerrado. Esto significa que no fluye corriente a través de ninguno de los componentes y, por lo tanto, no hay caída de voltaje. En otras palabras, todos los voltajes son 0V. Esto incluye el voltaje de salida = 0V.

(b) L2 abierto

Al igual que el caso cuando se abrió L1, si se abre L2, ya no hay un circuito cerrado. Esto significa que no fluye corriente a través de ninguno de los componentes y, por lo tanto, no hay caída de voltaje. Voltaje de salida = 0V

(c) R1 Abierto
<img src="https://latex.codecogs.com/svg.image?\\\textit{Sin&space;R1&space;nuestro&space;crcuito&space;se&space;pone&space;en&space;serie}\\[5pt]Z_{T}=R_{2}&plus;R_{3}&plus;jX_{L1}&plus;jX_{L2}\\[5pt]Z_{T}=100\Omega&space;&plus;56\Omega&space;&plus;j50.3\Omega&space;&plus;j25.1\Omega&space;=156\Omega&space;&plus;j75.4\Omega&space;\\[5pt]\textit{En&space;forma&space;polar}\\[5pt]Z_{T}=\sqrt{(156\Omega&space;)^{2}&plus;(75.4\Omega&space;)^{2}}\angle&space;tan^{-1}(\frac{75.4\Omega&space;}{156\Omega&space;})=173\angle&space;25.8^{\circ}\Omega&space;\\[5pt]\textit{Usamos&space;el&space;divisor&space;de&space;voltaje&space;para&space;encontrar&space;el&space;voltaje&space;de&space;salida}\\[5pt]V_{OUT}=(\frac{R_{3}}{Z_{T}})V_{s}=(\frac{56\angle&space;0^{\circ}\Omega&space;}{173\angle&space;25.8^{\circ}V})(5\angle&space;0^{\circ}V)=1.62\angle&space;-25.8^{\circ}V&space;" title="\\\textit{Sin R1 nuestro crcuito se pone en serie}\\[5pt]Z_{T}=R_{2}+R_{3}+jX_{L1}+jX_{L2}\\[5pt]Z_{T}=100\Omega +56\Omega +j50.3\Omega +j25.1\Omega =156\Omega +j75.4\Omega \\[5pt]\textit{En forma polar}\\[5pt]Z_{T}=\sqrt{(156\Omega )^{2}+(75.4\Omega )^{2}}\angle tan^{-1}(\frac{75.4\Omega }{156\Omega })=173\angle 25.8^{\circ}\Omega \\[5pt]\textit{Usamos el divisor de voltaje para encontrar el voltaje de salida}\\[5pt]V_{OUT}=(\frac{R_{3}}{Z_{T}})V_{s}=(\frac{56\angle 0^{\circ}\Omega }{173\angle 25.8^{\circ}V})(5\angle 0^{\circ}V)=1.62\angle -25.8^{\circ}V " />
